...
//        TransaksiDetilPK pk = new TransaksiDetilPK(transaksiMaster.getPk().getTransaksiId(), transaksiMaster.getPk().getSbuId(), Constants.KodeKurNonKurSAA.NON_KUR);
        transaksiDetailMap.put(1, new TransaksiDetil(new TransaksiDetilPK(transaksiMaster.getPk().getTransaksiId(), transaksiMaster.getPk().getSbuId(), Constants.KodeKurNonKurSAA.NON_KUR, 1D), Constants.IdCoaPenSAA.PREMI_PEN, transaksiMaster.getTanggal(), jurnalProduksiIjpDTO.getNilaiIjp().abs(), BigDecimal.ZERO, BigDecimal.ZERO, transaksiMaster.getKeterangan(), transaksiMaster.getBulan(), transaksiMaster.getTahun(), transaksiMaster.getIdSbuPusat(), transaksiMaster.getSbuInduk()));
        transaksiDetailMap.put(2, new TransaksiDetil(new TransaksiDetilPK(transaksiMaster.getPk().getTransaksiId(), transaksiMaster.getPk().getSbuId(), Constants.KodeKurNonKurSAA.NON_KUR, 2D), Constants.IdCoaPenSAA.PIUTANG_PREMI_PEN, transaksiMaster.getTanggal(), BigDecimal.ZERO, jurnalProduksiIjpDTO.getNilaiIjp().abs(), BigDecimal.ZERO, transaksiMaster.getKeterangan(), transaksiMaster.getBulan(), transaksiMaster.getTahun(), transaksiMaster.getIdSbuPusat(), transaksiMaster.getSbuInduk()));
        transaksiDetailMap.put(3, new TransaksiDetil(new TransaksiDetilPK(transaksiMaster.getPk().getTransaksiId(), transaksiMaster.getPk().getSbuId(), Constants.KodeKurNonKurSAA.NON_KUR, 3D), Constants.IdCoaPenSAA.UTANG_LOSS_RASIO_PEN, transaksiMaster.getTanggal(), jurnalProduksiIjpDTO.getNilaiCadangan().abs(), BigDecimal.ZERO, BigDecimal.ZERO, transaksiMaster.getKeterangan(), transaksiMaster.getBulan(), transaksiMaster.getTahun(), transaksiMaster.getIdSbuPusat(), transaksiMaster.getSbuInduk()));
        transaksiDetailMap.put(4, new TransaksiDetil(new TransaksiDetilPK(transaksiMaster.getPk().getTransaksiId(), transaksiMaster.getPk().getSbuId(), Constants.KodeKurNonKurSAA.NON_KUR, 4D), Constants.IdCoaPenSAA.BEBAN_LOSS_RASIO_PEN, transaksiMaster.getTanggal(), BigDecimal.ZERO, jurnalProduksiIjpDTO.getNilaiCadangan().abs(), BigDecimal.ZERO, transaksiMaster.getKeterangan(), transaksiMaster.getBulan(), transaksiMaster.getTahun(), transaksiMaster.getIdSbuPusat(), transaksiMaster.getSbuInduk()));
